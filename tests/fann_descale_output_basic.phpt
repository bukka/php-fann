--TEST--
Test function fann_descale_output_basic() by calling it with its expected arguments
--FILE--
<?php
...
$filename = ( dirname( __FILE__ ) . "/fann_descale_output.tmp" );
$content = <<<EOF
4 2 1
-1 -1
-1
...
var_dump(fann_descale_output($ann, $output));
